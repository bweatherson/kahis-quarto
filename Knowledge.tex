...
Friedman (\citeproc{ref-Friedman2024}{2024}) has developed a detailed
...
well.\footnote{Note that Friedman (\citeproc{ref-Friedman2024}{2024})
...
best explanation of why Blaise's action is wrong. Without that argument,
it's hard to infer from Blaise's case that knowledge is
...
While hero's evidence is strong, it isn't maximally strong. Despite
...
interest-relative.\footnote{I am opposed to something that many
  ...
  namely meta-linguistic norms on assertion, reasoning, and action. That
  opposition doesn't extend to contextualism in general.}
...
Friedman, Jane. (2024). The aim of inquiry? \emph{{P}hilosophy and
