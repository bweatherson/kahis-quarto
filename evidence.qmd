...
Now I can offer a simple, but incomplete, solution. Let *p* be the proposition that she might or might not know, and the question of whether *V*(*O*) ≥ *x* be the only salient question to which *p* is relevant. Then she knows *p* only if \[*V*^-^(*O*\|*K*) + *V*^-^(*O*\|*K* ∧ *p*)\] ≥ *x*. That is, we work out the value of *O* with and without the evidence *p*, and if the average is greater than *x*, good enough!
